...
while IFS=" " read -r sample_name path; do
  ...
  outdir=/home/abportillo/github_repo/RNA_seq_Bcell/scripts/raw_fastq_bcell/rnaPreprocess/counts_tx/${sample_name}
...
#SBATCH --output=${sample_name}_getTxCounts_%j.log\n
...
${outdir}/${sample_name}/${sample_name}_ballgownGTFinfo.txtZZ
